...
$pdf->Cell(0, 12, '您的交通工具（车辆详情', 0, 1, 'L');
$pdf->Ln(4);
...
if (!empty($data['vehicle'])) {
    ...
    $pdf->MultiCell(0, 6, "**上方的车辆信息仅供参考，可能会有所变动。我们的团队成员会与您确认最终车辆。", 0, 'L');
...
$pdf->Cell(0, 12, '多种支付方式', 0, 1, 'L');
$pdf->Ln(4);

// Subheading
$pdf->SetFont('stsongstdlight', '', 12);
$pdf->SetTextColor(60, 60, 60);
$pdf->Cell(0, 6, '我们接受以下国际支付系统', 0, 1, 'L');
$pdf->Ln(5);
