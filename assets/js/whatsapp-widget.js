document.addEventListener("DOMContentLoaded", () => {
    ...
    const showIncomingMessage = () => {
        if (!hasShownWelcomeMessage) {
            ...
            incomingMessage.textContent = "🌍 Discover unforgettable journeys with Explore Vacations. From guided tours to tailor-made travel experiences, let us help you explore Sri Lanka with confidence and comfort ✨🇱🇰";
    ...
    whatsappBtn.addEventListener("click", () => {
        window.open("https://api.whatsapp.com/send/?phone=%2B94761414554&text&type=phone_number&app_absent=0", "_blank");
        toggleChat(false);
    });
});
